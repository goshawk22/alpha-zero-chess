...
class PawnsNNet():
    def __init__(self, game, args):
        ...
        # Neural Net
        # Inputs
        self.input_boards = Input(shape=(2,8,8))
        inputs = Reshape((8, 8, 2, 1))(self.input_boards)


        bn1 = BatchNormalization()(inputs)
        conv1 = Conv3D(args.num_channels, kernel_size=3, strides=1, padding="same")(bn1)
        t = relu_bn(conv1)
